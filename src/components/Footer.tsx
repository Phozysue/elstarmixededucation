  ...
  return <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              />
              <span className="font-bold text-lg">Elstar Mixed Education Centre</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/school" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  Visit School
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-primary-foreground/80">P.O. Box 54145-0100, Nairobi, Kenya</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 flex-shrink-0" />
                <span className="text-primary-foreground/80">+254 700901266/ +254 754323024</span>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-6 text-center text-sm text-primary-foreground/80">
          <p>© {new Date().getFullYear()} Elstar Mixed Education Centre. All rights reserved.</p>
