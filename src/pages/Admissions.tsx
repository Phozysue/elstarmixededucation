  ...
  return <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Join our community of learners. We're excited to welcome your family to Elster Mixed Educational Centre.</p>
        </div>
        ...
        <div className="bg-muted/30 rounded-lg p-8 md:p-12 mb-20">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-4 text-muted-foreground">
            <p>Elster Mixed Educational Centre is committed to making quality education accessible to all qualified students.</p>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Start your application today or schedule a visit to learn more about Elster Mixed Educational Centre.</p>
