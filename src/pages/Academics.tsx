  ...
  const successStories = [
    {
      ...
      story: "The rigorous academic program and supportive teachers at Elster Mixed Educational Centre prepared me for the challenges of Ivy League admission. I'm now pursuing my dream of studying medicine.",
      avatar: "",
      program: "High School",
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Elster Mixed Educational Centre offers a comprehensive curriculum designed to challenge and inspire students at every level.
          </p>
        </div>
