...
import { Target, Eye, Heart, User, BookOpen, Calendar, Users, MapPin, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-6 text-foreground">About Elstar Mixed Education Centre</h1>
        ...
        <div className="bg-muted/30 rounded-lg p-8 md:p-12 mb-20">
          ...
          {loading ? (
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>
                It is with great pride and enthusiasm that I welcome you to Elstar Mixed Education Centre.
              </p>
            </div>
          )}
        </div>
        ...
        <div>
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-muted-foreground">
            <p>
              Elstar Mixed Education Centre was founded with a vision to provide quality education that nurtures not just academic excellence, but also strong character, leadership skills, and a sense of social responsibility.
            </p>
            <p>
            ...
            <p>
              Today, Elstar Mixed Education Centre stands as a testament to our commitment to educational excellence. Our graduates have gone on to attend prestigious universities and pursue successful careers in various fields, making us proud of their achievements and contributions to society.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <Link to="/school" className="group">
              <Card className="border-none shadow-lg h-full transition-shadow group-hover:shadow-xl">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    View our address, office hours, and map to plan your visit to the school.
                  </p>
                  <span className="inline-flex items-center gap-1 text-primary font-medium">
                    Plan your visit <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                  </span>
                </CardContent>
              </Card>
            </Link>
